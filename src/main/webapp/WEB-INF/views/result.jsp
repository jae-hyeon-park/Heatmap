...
<body>
   <%
      ...
      if( mtype.equals("user")){  //응답폼 등록하려할때 로그인이나 회원가입으로 넘어온 id가 없을경우
          PrintWriter script = response.getWriter();
...
<div class="fh5co-loader"></div>
   ...
   <div class="container">
      <div class="table-responsive">
         ...
         <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
            <thead>
               <tr>
                  ...
                  <th style="background-color: #eeeeee; text-align: center;">등록자 아이디</th>
            ...
            for(HeatMapFormData data : list) {
               ...
               */
               ...
               int count = 0;
               count = manager.getSearchCount(s_type, s_value); // 데이터베이스에 저장된 총 갯수
               System.out.println("count"+count);
               List<HeatMapFormData> list = null;
               
               if (count > 0) {
                  // getList()메서드 호출 / 해당 레코드 반환
                  list = manager.selectSearchList(s_type, s_value,startRow-1);
               }
         ...
         %>
                  <a href="result?pageNum=<%=startPage - 10%>">[이전]</a>   
         <%         
               }
         ...
         %>
                  <a href="result?pageNum=<%=startPage + 10 %>">[다음]</a>
         <%         
               }
            }
         %>
   ...
   <div>
      ...
      <form method="post" action="result3">
         ...
         <input type="submit" value="다운" class="btn btn-primary" style="float: right;">
      </form>
